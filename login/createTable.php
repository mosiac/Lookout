...
$result = mysql_query("CREATE TABLE `page` ( `id` INT NOT NULL AUTO_INCREMENT , `name` TEXT NOT NULL , `timeCreated` TEXT NOT NULL , `pageUrl` TEXT NOT NULL , `hashTags` TEXT NOT NULL , `peopleRef` TEXT NOT NULL ,  PRIMARY KEY ( `id` ) );");
if(mysql_error()){
